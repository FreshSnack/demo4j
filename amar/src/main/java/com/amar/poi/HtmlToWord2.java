...
public class HtmlToWord2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (HashMap<String, String> img : imgs) {
            ...
            try {
                String imagePath = HtmlToWord2.class.getResource("/" + img.get("src")).getPath();
        ...
        try {
            ...
            FileOutputStream ostream = new FileOutputStream(outputPath + "\\temp.doc");
            ...
            //最终生成的带图片的word文件
            FileOutputStream fopts = new FileOutputStream(outputPath + "\\final.docx");
            doc.write(fopts);
            fopts.close();
        } catch (Exception e) {
            e.printStackTrace();
